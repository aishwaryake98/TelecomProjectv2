...
// }
sgMail.setApiKey(
  "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",
);
...
export async function sendOTPEmail(email: string, userName: string) {
  ...
  const msg = {
    to: email,
    from: "aishwaryake1998@gmail.com", // Using Replit domain for demo
...
export async function sendWelcomeEmail(
  ...
  try {
    ...
    console.log(
      `DEMO MODE - Welcome email for ${userName} at ${email} with account ${accountNumber}`,
    );
    return {
      success: true,
